            ...
            <div class="w-full sm:w-1/1 md:w-1/2 lg:w-1/2 flex flex-col rounded overflow-hidden shadow-lg">
                    ...
                    <div class="p-3 flex flex-col flex-1 ">
                        ...
                        <div class="font-base text-lg text-sisahy-darker p-2 rounded-t text-center">
                            <h2 class="mb-2  text-bland text-lg">เลขที่ใบรับส่ง : {{ $order->order_header_no }}</h2>  
                            <p class=" text-grey-darker no-underline text-base">วันที่รับสินค้า : {{  $order->order_header_date }}</p>
