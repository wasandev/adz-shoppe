    ...
    <nav class="flex items-center justify-between shadow flex-wrap bg-sisahy p-2" >
        <div class="flex items-center flex-no-shrink text-red-light mr-4 md:items-center">
            <svg class="fill-current h-12 w-12 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <span class="font-semibold text-xl tracking-tight text-red-light">SISAHY GO</span>
        </div>

        <div class="block lg:hidden">
            <button @click="toggle" class="flex items-center px-2 py-2  text-white hover:text-red">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
                ...
                <div>
                    ...
                    <a href="#responsive-header" class="mr-2 no-underline text-white hover:text-red transition text-base mr-3">
                        บริการ
                    </a>
                </div>  --}}
            ...
            <div>
              {{--
                ...
                @else
                    <a href="{{ route('login') }}" class="mr-2 no-underline text-white hover:text-red transition text-base mr-3">
