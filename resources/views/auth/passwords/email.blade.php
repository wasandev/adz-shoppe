...
<div class="flex flex-wrap items-center py-32 px-4 py-32 md:px-0">
    <div class="w-full max-w-md md:mx-auto">
        <div class="rounded shadow">
            <div class="font-medium text-base bg-indigo text-white p-3 rounded-t">
                {{ __('Reset Password') }}
            </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="flex">
                        <div class="w-3/4 ml-auto">
                            <button type="submit" class="bg-indigo text-grey-lighter hover:text-white text-base font-semibold py-2 px-4 rounded mr-3">
